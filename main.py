...
def help():
    ...
    stdout.write("             "+Fore.MAGENTA            +"║ \x1b[38;2;255;20;147m• "+Fore.CYAN+"exit     "+Fore.MAGENTA+"|"+Fore.CYAN+" Exit SONIC DDoS Panel                  "+Fore.MAGENTA+"║\n")
    stdout.write("             "+Fore.MAGENTA            +"╠═════════════════════════════════════════════════════╣\n")
    stdout.write("             "+Fore.MAGENTA            +"║ \x1b[38;2;255;20;147m• "+Fore.CYAN+"Socials  "+Fore.MAGENTA+"|"+Fore.CYAN+" PRIVATE SORRY                "+Fore.MAGENTA+"║\n")
    stdout.write("             "+Fore.MAGENTA            +"║ \x1b[38;2;255;20;147m• "+Fore.CYAN+"github   "+Fore.MAGENTA+"|"+Fore.CYAN+" https://github.com/MrMarko   "+Fore.MAGENTA+"║\n")
...
def title():
    ...
    stdout.write("             "+Fore.MAGENTA            +"        ══╦═════════════════════════════════╦══\n")
    stdout.write("             "+Fore.MAGENTA+"╔═════════╩═════════════════════════════════╩═════════╗\n")
    stdout.write("             "+Fore.MAGENTA+"║ "+Fore.CYAN   +"         WE DONT DIE WE MULTIPLY         "+Fore.MAGENTA  +"       ║\n")
    stdout.write("             "+Fore.MAGENTA+"║ "+Fore.CYAN   +"          PRIVATE TOOLS     "+Fore.MAGENTA +"       ║\n")
    stdout.write("             "+Fore.MAGENTA+"║ "+Fore.CYAN   +"           DEVELOPER   @MrMarko   "+Fore.MAGENTA +"            ║\n")
    stdout.write("             "+Fore.MAGENTA+"╚═════════════════════════════════════════════════════╝\n") 
    stdout.write("\n")

def command():
    stdout.write(Fore.MAGENTA+"╔═══"+Fore.MAGENTA+"[""root"+Fore.LIGHTMAGENTA_EX+"@"+Fore.MAGENTA+"MrMarko"+Fore.CYAN+"]"+Fore.MAGENTA+"\n╚══\x1b[38;2;0;255;189m> "+Fore.WHITE)
    command = input()
